      ...
      <table class="interest-table">
        ...
        <tr>
          ...
          <td>
            ...
            be INR 2% of the loan amount, whichever is
            higher.
          </td>
        </tr>
        <tr>
  ...
  <div class="content">
    ...
    <table class="kfs-table">
      ...
      <tr>
        ...
        <td class="kfs-td">₹ ${interest_amount}</td>
      </tr>
      <tr>
        <td class="kfs-td">(j)</td>
        <td class="kfs-td">Processing Fee</td>
        <td class="kfs-td">₹ ${pf_amount}</td>
      </tr>
      <tr>
  ...
  <div class="content">
    <table class="kfs-table">
      <tr>
        ...
        <td>Interest Rate</td>
        <td>
          Interest on the Loan: Interest on the Loan: ${roi}% from the
          date of disbursal until the date of repayment. In the event of
          failure to make payment on due date, a penal interest of 2% shall be applicable from the due date until the
          date of payment.
        </td>
      </tr>
      <tr>
